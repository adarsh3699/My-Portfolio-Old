...
function FootBar() {
    return (
        <div id="bottomBar">
            ...
            <div id="footSocial">
                <a href="mailto:adarsh3699@gmail.com" target="_blank" rel="noreferrer">
                    <img src={googleImg} height="22px" alt="" />
                    <div> adarsh3699</div>
                </a>

                <a href="https://github.com/adarsh3699" target="_blank" rel="noreferrer">
                    <svg height="18" fill="white" style={{ marginRight: "5px" }} viewBox="0 0 16 16" version="1.1" id="git">
